...
export default function Installation() {
    ...
    const command = "go install github.com/vypher-io/cli@latest";
        ...
        <section id="install" className="py-24 px-4 bg-brand-dark relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
                ...
                <p className="mt-4 text-gray-500 text-sm">
                    Requires Go 1.20+. Check <a href="https://github.com/vypher-io/cli" className="text-brand-secondary hover:underline">documentation</a> for binary releases.
                </p>
            </div>
        </section>
    );
